...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	chmod 644 out/target/product/lt033gxx/recovery/root/init.rc
	chmod 644 out/target/product/lt033gxx/recovery/root/default.prop
	(cd out/target/product/lt033gxx/recovery/root/ && find * | sort | cpio -o -H newc) | gzip > $(recovery_ramdisk)
